#Inversing matrices may be very costly in ressources and time. It is often preferable to cache a result of a 
...
#and sets the new inverse value in the cache via the setinverse function.
